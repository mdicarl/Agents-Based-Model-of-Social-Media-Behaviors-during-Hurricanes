...
class HurricaneModel(Model):
   ...
   def __init__(
       ...
       self.G = nx.fast_gnp_random_graph(n=self.num_nodes, p=prob, seed=None)  # nx.convert_node_labels_to_integers
...
batch_run.run_all()
# #lowlow
run_data = batch_run.get_model_vars_dataframe().to_csv("testnetworkrandomrangeLARGEWELL.csv")
